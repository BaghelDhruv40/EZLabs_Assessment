...
const Navbar = ({ showLogo }) => {
	...
	return (
		<nav
			className="fixed top-0 left-0 w-full flex items-center justify-between px-4 sm:px-6 md:px-8 lg:px-10 h-[80px] sm:h-[90px] lg:h-[103px]  z-50 "
			style={{
		...
		>
			...
			{menuOpen && (
				<div
					className={`absolute right-[20px] sm:right-[50px] md:right-[70px] lg:right-[90px] mt-[100px] sm:mt-[110px] lg:mt-0 flex items-center justify-end  lg:bg-transparent transition-all duration-500 z-[40] rounded-xl lg:rounded-none p-4 lg:p-0  shadow-md lg:shadow-none ${
